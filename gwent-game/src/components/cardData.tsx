...
export const cardPool: CardData[] = [
    ...
    { id: 101, type: "Close Combat", name: "Infantry Drone", power: 5, ability: "Tight Bond", lore: "Infantry Drones, modeled after ancient warriors but enhanced with lethal precision and unyielding stamina, lead the charge in ground battles across the cosmos." },
    { id: 102, type: "Close Combat", name: "Cyber Knight", power: 7, ability: "Morale Boost", lore: "Cyber Knights are elite warriors, blending centuries-old combat traditions with modern exoskeleton enhancements." },
    { id: 103, type: "Close Combat", name: "Mechanized Infantry", power: 6, ability: "Medic", lore: "These advanced combat suits can be airdropped into the fiercest fights, where their pilots provide crucial support and firepower." },
    { id: 104, type: "Close Combat", name: "Exo-Soldier", power: 8, ability: "Agile", lore: "Exo-Soldiers wear suits powered by miniaturized fusion reactors, making them formidable assets in any engagement zone." },
    { id: 105, type: "Close Combat", name: "Captain Elise Durant", power: 10, ability: "Hero", lore: "Captain Durant, a legendary pilot known for her daring maneuvers in close-quarters space combat, has now brought her expertise to the ground forces." },
    // Human Ranged Combat cards
    { id: 111, type: "Ranged Combat", name: "Tactical Sniper", power: 7, ability: "Scorch", lore: "Equipped with adaptive camouflage and high-velocity railguns, Tactical Snipers can change the tide of war from kilometers away." },
    { id: 112, type: "Ranged Combat", name: "Recon Drone", power: 4, ability: "Spy", lore: "Recon Drones silently gather critical battlefield intelligence, often turning invisible to enemy sensors." },
    { id: 113, type: "Ranged Combat", name: "Artillery Specialist", power: 6, ability: "Muster", lore: "Artillery Specialists control the battlefield with precise long-range bombardments, decimating enemy fortifications from afar." },
    { id: 114, type: "Ranged Combat", name: "Comms Officer", power: 5, ability: "Morale Boost", lore: "Comms Officers maintain the flow of vital information across the battlefield, boosting the morale and coordination of allied troops." },
    { id: 115, type: "Ranged Combat", name: "Lieutenant Marcus Fenix", power: 9, ability: "Hero", lore: "Marcus Fenix, a master sharpshooter, once turned the tide of a siege with a single shot that saved a thousand lives." },
    // Human Siege cards
